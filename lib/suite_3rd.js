 ...
 * @param auth_type 授权类型：0 正式授权， 1 测试授权， 默认值为0
 */
exports.setSessionInfo = function (pre_auth_code, appid, auth_type = 0) {
  return this.request({
    method: 'post',
 ...
 */
exports.getPermanentCode = function (auth_code) {
  return this.request({
    method: 'post',
 ...
 */
exports.getAuthInfo = function (auth_corpid, permanent_code) {
  return this.request({
    method: 'post',
 ...
 * @param permanent_code 永久授权码，通过get_permanent_code获取
 */
exports.getCorpToken = function (auth_corpid, permanent_code) {
  return this.request({
    method: 'post',
